...
figure.location <- "../reports/figures"
...
ggsave(paste(figure.location, "europese-vlinderindex-graslanden-1.png", sep = "/"))
```

![](../reports/figures/europese-vlinderindex-graslanden-1.png)
...
ggsave(paste(figure.location, "europese-vlinderindex-graslanden-2.png", sep = "/"))
```
...
ggsave(paste(figure.location, "europese-vlinderindex-graslanden-3.png", sep = "/"))
```
