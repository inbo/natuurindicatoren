...
p_nl_cum2 <- ggplot(data_flanders_en_lustrum, aes(x = lustrum, y=n)) +
  geom_col() +
  facet_wrap("habitat", nrow = 4, strip.position = "right") +
  scale_x_continuous(limits = c(1940, max(data_flanders_nl_cum2$first_observed)), labels = seq(1950,max(data_flanders_nl_cum2$first_observed), by = 10), breaks = seq(1950,max(data_flanders_nl_cum2$first_observed), by = 10), minor_breaks = seq(1950,max(data_flanders_nl_cum2$first_observed), by = 2)) +
  xlab("Jaar") +
...
ggsave("reports/figures/Invasives_Cumulative_first_observed_habitat_en_bar.jpg", plot = p_en_cum2)
ggsave("reports/figures/Invasives_Cumulative_first_observed_habitat_en_bar.png", plot = p_en_cum2)
ggsave("reports/figures/Invasives_Cumulative_first_observed_habitat_nl_bar.jpg", plot = p_nl_cum2)
ggsave("reports/figures/Invasives_Cumulative_first_observed_habitat_nl_bar.png", plot = p_nl_cum2)
