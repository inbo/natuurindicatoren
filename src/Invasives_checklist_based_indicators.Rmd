...
data_flanders_nl_cum2 <- 
  ...
  mutate(habitat = case_when(grepl("estuarien", habitat) ~ "estuarien",
                             grepl("marien", habitat) ~ "marien",
                             grepl("terrestrisch", habitat) ~ "terrestrisch",
                             grepl("zoetwater", habitat) ~ "zoetwater"))

data_flanders_en_cum <- 
  data_flanders_nl_cum2 %>% 
  mutate(habitat = case_when(grepl("estuarien", habitat) ~ "estuarine",
                             grepl("marien", habitat) ~ "marine",
                             grepl("terrestrisch", habitat) ~ "terrestrial",
                             grepl("zoetwater", habitat) ~ "freshwater"))
