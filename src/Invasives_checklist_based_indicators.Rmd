...
data_flanders_nl <- 
  ...
  mutate(habitat = case_when(habitat == "freshwater" ~ "zoetwater",
                             habitat == "freshwater|terrestrial" ~ "zoetwater|terrestrisch",
                             habitat == "marine" ~ "marien",
                             habitat == "marine|freshwater" ~ "marien|zoetwater", 
                             habitat == "terrestrial" ~ "terrestrisch"))

p_en <- indicator_introduction_year(data_flanders_en, start_year_plot = 1940,
                                 x_major_scale_stepsize = 10, x_minor_scale_stepsize = 2,
                                 facet_column = "habitat", first_observed = "first_observed")

p_nl <- indicator_introduction_year(data_flanders_nl, start_year_plot = 1960,
                                 x_major_scale_stepsize = 10, x_minor_scale_stepsize = 2,
                                 facet_column = "habitat", first_observed = "first_observed") 



ggsave("reports/figures/Invasives_first_observed_habitat_en.jpg", plot = p_en )
```
...
tabel_pathways_beide <- 
  ...
  mutate(introductieweg_niveau1 = case_when(introductieweg_niveau1 == "contaminant" ~ "besmetting",
                                            ...
                                            introductieweg_niveau1 == "release" ~ "vrijlating",
                                            introductieweg_niveau1 == "stowaway" ~ "verstekeling",
                                            introductieweg_niveau1 == "unaided" ~ "zonder hulp",
  ...
  mutate(introductieweg_niveau2 = case_when(introductieweg_niveau2 == "agriculture" ~ "landbouw",
                                            ...
                                            introductieweg_niveau2 == "food_bait" ~ "lokvoeder",
                                            ...
                                            introductieweg_niveau2 == "people_luggage" ~ "baggage",
                                            introductieweg_niveau2 == "pet" ~ "huisdier",
                                            introductieweg_niveau2 == "research" ~ "onderzoek",
                                            introductieweg_niveau2 == "seed" ~ "zaad",
                                            introductieweg_niveau2 == "ship" ~ "schip",
                                            introductieweg_niveau2 == "timber" ~ "hout",
...
tabel_pathways_niveau1 <- 
  ...
  mutate(introductieweg = case_when(introductieweg == "contaminant" ~ "besmetting",
                                            ...
                                            introductieweg == "release" ~ "vrijlating",
                                            introductieweg == "stowaway" ~ "verstekeling",
                                            introductieweg == "unaided" ~ "zonder hulp",
