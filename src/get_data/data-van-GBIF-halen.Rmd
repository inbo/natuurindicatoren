...
```{r}
print(plot <- ggplot(species_list, aes(x = firstyear, fill = as.factor(firstyear))) +
  geom_point(colour="red", fill="red", stat = "count")+
...
print(plot <- ggplot(species_list2, aes(x = firstyear, fill = as.factor(firstyear))) +
  geom_point(colour="red", fill="red", stat = "count") +
  xlab("Year") + ylab("Number") + ggtitle("Number of invasive species per year") +
