...
plot(map, xlim = c(2.54, 6.41), ylim = c(49.48, 51.51), asp = 1)

points(species_list$lon, airports$lat, col = "red", cex = .6)


library(plyr)
temp3 <- rename(WnmBe_All, c("species"="s"))
temp4 <- merge(species_list, temp3[c("decimallatitude", "decimallongitude", "s")], by="s", all.y = FALSE)
