...
```{r}
library(plyr)
number <- rle( sort(species_list$firstyear ) )
species_list$number <- number[[1]][ match(species_list$firstyear , number[[2]] ) ]
species_list


print(plot <- ggplot(species_list, aes(x = firstyear, y= number)) +
  geom_point(colour="black", fill="black")+
  geom_line(colour= "grey")+
    stat_smooth(color="red")+
  xlab("Year") + ylab("Number") + ggtitle("Number of invasive species per year") +
  scale_x_continuous(breaks = seq(1800, 2017, 10))+
...
print(plot <- ggplot(species_list2, aes(x = firstyear, y=number)) +
...
```{r}
library(scales)
species_list_2a <- subset(species_list2, kingdom =="Animalia")

print(plot <- ggplot(species_list_2a, aes(x = firstyear, y=number)) +
  geom_point(colour="black", fill="black", size = 4, position="dodge",stat="identity") +
  geom_line(colour= "grey")+
  stat_smooth(color="red")+
  xlab("Year") + ylab("Number") + ggtitle("Number of invasive animal species per year") +
  scale_x_continuous(breaks = seq(1940, 2017, 10))+
  scale_y_continuous(limit=c(0,200),oob=squish),breaks = seq(0,200, 50))

```

Make a graph of the number of invasive plant species
```{r}
species_list_2p <- subset(species_list2, kingdom =="Plantae")

print(plot <- ggplot(species_list_2p, aes(x = firstyear, y=number)) +
  geom_point(colour="black", fill="black", size = 4, position = "dodge",stat="identity") +
  geom_line(colour= "grey")+
  stat_smooth(color="red")+
  xlab("Year") + ylab("Number") + ggtitle("Number of invasive plant species per year") +
  scale_x_continuous(breaks = seq(1940, 2017, 10))+
  scale_y_continuous(limit=c(0,200),oob=squish),breaks = seq(0,200, 50))
...
```{r}
species_list_3a <- subset (species_list_2a, species_list_2a$class %in% c("Actinopterygii", "Amphibia", "Arachnida", "Aves", "Bivalvia", "Gastropoda", "Hydrozoa", "Insecta", "Malacostrata", "Mammalia", "Maxillopoda", "Reptilia"))

print(plot <- ggplot(species_list_3a, aes(x = firstyear, y=number)) +
  geom_point(colour="black", fill="black", size = 4, position="dodge",stat="identity") +
...
```{r}
species_list_3p <- subset (species_list_2p, species_list_2p$class %in% c("Liliopsida", "Magnoliopsida", "Pinopsida", "Polypodiopsida"))


print(plot <- ggplot(species_list_3p, aes(x = firstyear, y=number)) +
  geom_point(colour="black", fill="black", size = 4, position="dodge",stat="identity") +
